...
\begin{itemize}
	...
	\begin{itemize*}
		...
		\item Administration of a very large Bro cluster
		\item Installation of a Collective Intelligence Framework server
		...
		\item Deployed Nagios and wrote plug-ins to monitor servers and network devices
...
\item
	...
	\begin{itemize*}
		...
		\item Administer a SecurityOnion deployment, write Snort rules and Bro scripts
		\item Nagios and Multi-Router Traffic Grapher deployment for network monitoring
		\item Provide OSX Server support
	\end{itemize*}
\end{itemize}
...
\begin{itemize}
	...
	\item Working knowledge of FreeBSD, OpenBSD, OSX, Gnu/Linux (Red Hat, Debian), Windows, Cisco IOS
	...
	\item Experience in the automation of administrative tasks on unix-like systems with Bash and Korn shell programming. Additional experience with Awk, Bro, C, \LaTeX, and Expect. Very comfortable with command-line interfaces.
...
\begin{itemize}
	...
	\item \textsc{Member} -- USENIX, ACM, ISSA Kentuckiana, Infragard, and Appalachian Institute of Digital Evidence
