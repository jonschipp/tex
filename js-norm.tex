...
\item
	...
	\begin{itemize*}
		\item Nagios deployment for a large number of network security monitoring sensors.
		\item Write custom Nagios plug-ins for SecurityOnion and NSM tools
		\item Automating deployment and configuration with Puppet and shell scripts
	\end{itemize*}
\end{itemize}
