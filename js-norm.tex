...
\begin{itemize}
	...
	\begin{itemize*}
		...
		\item Provisioning systems with Puppet and Git
...
\item
	...
	\begin{itemize*}
		\item Nagios for a large number of network security monitoring sensors.
		\item Write custom Nagios plug-ins for SecurityOnion and NSM tools
		\item Automate deployment and configuration with Puppet and shell scripts
	\end{itemize*}
\end{itemize}
